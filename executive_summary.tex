...
Reproduction identified material gaps between the original paper and released code. Architecture, validation, checkpoint selection, physical geometry, tuning, and sampling are incompletely or inconsistently specified \cite{hu_learning_2024,hu_jasonhu4padis_2026-1}. The three implementation tracks show that plausible interpretations can reverse the central comparison. Therefore, complete geometry, data splits, tuning procedures, and executable algorithms are required to distinguish methodological improvements from implementation effects.
