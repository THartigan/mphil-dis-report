...
Several limitations, however, still constrain the clinical applicability of this work. Experiments only used one dataset, simulated two-dimensional measurements, and performed a single training run per model. Computationally expensive comparisons also use four images, and we exclude photon noise, scatter, beam hardening, and motion throughout. Our reported intervals describe variation between slices rather than retraining uncertainty, and no clinical expert has assessed nodule preservation or hallucination.
