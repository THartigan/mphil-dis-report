...
Pipeline logs give order-of-magnitude timings under possible GPU sharing. PaDIS-DPS took about two minutes per slice, $24\%$ below whole-image VE-DPS. Fixed patch methods took about $24$ minutes. These are not isolated benchmarks.

\begin{table}[htbp]
\centering
\caption[Logged reconstruction time per slice.]{Mean 20-view wall time per slice from non-isolated pipeline logs.}\label{tab:runtime}
\small
\begin{tabular}{llr}
\toprule[1.1pt]
