...
\begin{itemize}[leftmargin=1.5em,itemsep=0.1em,topsep=0.2em,parsep=0pt]
    ...
    \item Compare the Paper-Faithful and Repo-Faithful reproductions and evaluate the LION-Physical operator-normalised extension introduced here.
...
This work therefore tests the generalisability of the central claims made by Hu et al. \cite{hu_learning_2024} across different data and geometry rather than seeking numerical identity. The remaining sections present the background, methods, results and discussion before the conclusion.
